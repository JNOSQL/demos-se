...
public class XMLResourceProducer implements ResourcesProducer{
    ...
    @Inject
    @ConfigurationUnit(name = "document", database = ResourcesProducer.HEROES, fileName = "jnosql.xml")
    ...
    @Inject
    @ConfigurationUnit(name = "document", database = ResourcesProducer.HEROES, fileName = "jnosql.xml", qualifier = "xml")
